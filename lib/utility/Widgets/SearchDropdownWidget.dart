...
class _SearchDropdownWidgetState extends State<SearchDropdownWidget> {
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: ThemeData(
        textTheme: TextTheme(titleMedium: TextStyle(color: widget.selectedItem.isEmpty ? Colors.grey.shade600 : Colors.black)),
      ),
      child: DropdownSearch<String>(
        ...
        popupProps: PopupProps.menu(
          ...
          constraints: BoxConstraints(maxHeight:  widget.maxHeight == false ? 300 : widget.maxHeight,),
