...
class ReceivedLRReport extends StatefulWidget {
  const ReceivedLRReport({Key? key}) : super(key: key);

  @override
  State<ReceivedLRReport> createState() => _ReceivedLRReportState();
}
...
class _ReceivedLRReportState extends State<ReceivedLRReport> with Utility {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: UiDecoration.appBar("Received LR Report"),
      body: Container(
