...
class _TrafficState extends State<Traffic> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(backgroundColor: ThemeColors.primaryColor,),
        body: MasonryGridView.builder(
      itemCount: cityName.length - 310,
      ...
      itemBuilder: (context, index) =>
          Padding(
              ...
              child: UiDecoration().inTransit('${cityName[index]}  $index' , "On Road",UiDecoration().inTransitReported())),
    )
