...
class TrafficVehicleInfo extends StatefulWidget {
  ...
  int? activityStatus;
  TrafficVehicleInfo(
      {Key? key, required this.vehicleDetails, required this.vehicleId,required this.activityId,required this.activityStatus,required this.vehicleDocument})
      : super(key: key);
...
class _TrafficVehicleInfoState extends State<TrafficVehicleInfo>
  ...
  TextEditingController dayControllerMajorIssue = TextEditingController(text: GlobalVariable.displayDate.day.toString().padLeft(2,'0'));
  TextEditingController monthControllerMajorIssue = TextEditingController(text: GlobalVariable.displayDate.month.toString().padLeft(2,'0'));
  TextEditingController yearControllerMajorIssue = TextEditingController(text: GlobalVariable.displayDate.year.toString());
  TextEditingController dayControllerVehicleActivity = TextEditingController(text: GlobalVariable.displayDate.day.toString().padLeft(2,'0'));
  TextEditingController monthControllerVehicleActivity = TextEditingController(text: GlobalVariable.displayDate.month.toString().padLeft(2,'0'));
  TextEditingController yearControllerVehicleActivity = TextEditingController(text: GlobalVariable.displayDate.year.toString());
  int? activityStatus;
  ...
  void initState() {
    ...
    activityStatus ==3 ?dropDownValue=list.first:activityStatus==4?dropDownValue=list.elementAt(1):activityStatus ==0?dropDownValue=list.elementAt(2): activityStatus ==5?dropDownValue=list.elementAt(3):activityStatus ==6? dropDownValue=list.elementAt(4):'';
    vehicleDetailsBGColor = activityStatus == 3  ?  ThemeColors.greenColor : activityStatus == 4 ? Colors.grey.shade700 : activityStatus == 0 ? ThemeColors.redColor :activityStatus == 5 ? ThemeColors.yellowColor:activityStatus == 6 ?ThemeColors.orangeColor:Colors.lightBlueAccent;
              ...
              Row(
                children: [
                  ...
                  CircleAvatar(
                    ...
                    radius: 25,
                    backgroundImage: widget.vehicleDetails['driver_data'] != null &&
                            widget.vehicleDetails['driver_data'][0]['driver_photo'] !=
                                null &&
                            widget.vehicleDetails['driver_data'][0]['driver_photo']
                                    .toString() !=
                                ""
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        widget.vehicleDetails.containsKey('driver_data')?widget.vehicleDetails['driver_data'][0]['driver_name']
                            .toString():'-',
                      ...
                      Text(
                        'Guarantor Name: ${widget.vehicleDetails.containsKey('driver_data') &&
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: widget.vehicleDetails.containsKey('driver_data')?widget.vehicleDetails[
                                                      'driver_data']
                                                  [0]['driver_photo'] ==
                                              ""
                                          ? const CircleAvatar(
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
    widget.vehicleDetails.containsKey('driver_data')?widget.vehicleDetails['driver_data']
                                                  [0]['driver_name']
                                              .toString():'-',
                                          style: const TextStyle(
                                        ...
                                        Text(
                                          'Guarantor Name: ${widget.vehicleDetails.containsKey('driver_data') &&
                                              widget.vehicleDetails['driver_data'][0]['guarantor_name'] != null?
                                          widget.vehicleDetails['driver_data']['guarantor_name'].toString(): '-'}',
                                          style: TextStyle(
                                              fontSize: 11,
                                              color: Colors.grey.shade600,
                                              fontWeight: FontWeight.w400),
                    ...
                    Wrap(
                      children: [
                            ...
                            return InkWell(
                              ...
                              child: AnimatedContainer(
                                ...
                                child: FormWidgets().containerWidget(
                                    'Late Delivery',
                                    GlobalVariable.dashboardHeaders.isEmpty?'-':GlobalVariable.dashboardHeaders[0]['late_delivery'].toString(),
                          ...
                          builder: (context, buttonProvider, child) {
                            return InkWell(
                              ...
                              child: AnimatedContainer(
                                ...
                                child: FormWidgets().containerWidget(
                                    'Late Loading',
                                    GlobalVariable.dashboardHeaders.isEmpty?'-':GlobalVariable.dashboardHeaders[0]['late_loaded'].toString(),
                                    ThemeColors.primaryColor),
                              ),
                            );
                          },
                            ...
                            return GestureDetector(
                              ...
                              child: InkWell(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  child: FormWidgets().containerWidget(
                                      'Pending LR',
                                      GlobalVariable.dashboardHeaders.isEmpty?'-':GlobalVariable.dashboardHeaders[0]['pending_lr'].toString(),
                                      ThemeColors.primaryColor),
                                ),
                              ),
                            );
                        ...
                        InkWell(
                            ...
                            child: FormWidgets().containerWidget(
                                'Vehicle Without Driver',
                                GlobalVariable.dashboardHeaders.isEmpty?'-':GlobalVariable.dashboardHeaders[0]['without_driver'].toString(),
                                ThemeColors.primaryColor)),
                        ...
                        InkWell(
                            ...
                            child: FormWidgets().containerWidget(
                                'Vehicle in Maintenance',
                                GlobalVariable.dashboardHeaders.isEmpty?'-':GlobalVariable.dashboardHeaders[0]['maintanance'].toString(),
                                ThemeColors.primaryColor)),
                            ...
                            return GestureDetector(
                              ...
                              child: InkWell(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  child: FormWidgets().containerWidget(
                                      'Major Issue',
                                      GlobalVariable.dashboardHeaders.isEmpty?'-':GlobalVariable.dashboardHeaders[0]['major_issue'].toString(),
                              ...
                              widget.vehicleDetails.containsKey('driver_data')?widget.vehicleDetails['driver_data']
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                          widget.vehicleDetails.containsKey('driver_data') &&
                                              widget.vehicleDetails['driver_data'][0]['guarantor_name'] != null
                                              ? widget.vehicleDetails['driver_data'][0]['guarantor_name'].toString()
                                              : '-',
                                        style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                ...
                child: TextFormField(
                  ...
                  decoration: UiDecoration().dateFieldDecoration('Select From Date and To Date'),
              )
          ),
          ...
          freshLoad ==1 ?const Center(child: CircularProgressIndicator()):vehicleRoutesList.isEmpty? Center(child: TextDecorationClass().heading1('Data Not Available')):Expanded(
            ...
            child: freshLoad == 1
                ...
                : Column(
                    children: [
                          ...
                          return SingleChildScrollView(
                            ...
                            child: Column(
                              children: [
                                ...
                                freshLoad == 1?const CircularProgressIndicator():UiDecoration().vehicleExpansionTile(
                                    vehicleRoutesList[index]['lr_number'],
                                    vehicleRoutesList[index]['expected_date'],
                                    UiDecoration().getFormattedDate(vehicleRoutesList[index]['activity_date']),
                                    vehicleRoutesList[index]['from_location'],
                                    vehicleRoutesList[index]['to_location'],
                                    vehicleRoutesList[index]['user_name'] ?? '-',
                                    'Pepsico India Holdings ',
                                    vehicleRoutesList[index]['activity_status']==0?'Empty':vehicleRoutesList[index]['activity_status']==1?'Pending':vehicleRoutesList[index]['activity_status']==2?'OnRoad':vehicleRoutesList[index]['activity_status']==3?'Reported':'Unloaded',
                                    vehicleRoutesList[index]['activity_status']==0?ThemeColors.redColor:vehicleRoutesList[index]['activity_status']==1?ThemeColors.orangeColor:vehicleRoutesList[index]['activity_status']==2?ThemeColors.darkBlueColor:vehicleRoutesList[index]['activity_status']==3?ThemeColors.greenColor:ThemeColors.grey700),
                                const Divider(),
                              ],
                            ),
                          );
                      ...
                      GlobalVariable.currentPage==GlobalVariable.totalPages?const SizedBox():freshLoad2==1?const CircularProgressIndicator(): InkWell(
                        onTap: () {
                          setStateMounted(() {
    ...
    return Responsive(
      ...
      /// Mobile
                  ...
                  child: Column(
                    ...
                    children: [
                      Wrap(
                        ...
                        runSpacing: 30,
                        children: [
                          info("LR No.", widget.vehicleDetails.containsKey('current')?widget.vehicleDetails['current']['lr_number'].toString():'-'),
                          info("Company Name", "T & D GALIAKOT CONTAINERS"),
                          info("From City", widget.vehicleDetails.containsKey('current')?widget.vehicleDetails['current']['from_location'].toString():'-',),
                          info("To City", widget.vehicleDetails.containsKey('current')?widget.vehicleDetails['current']['to_location'].toString():'-'),
                          // Action Dropdown
                                ...
                                showDialog(
                                  ...
                                  builder: (BuildContext context) => AlertDialog(
                                    ...
                                    content: SingleChildScrollView(
                                      child: Column(
                                        children: [
                                          dropDownValue == 'Reported' || dropDownValue == 'Unload'?const SizedBox():Row(
                                            children: [
                                              Expanded(
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    Text(dropDownValue == 'Send Empty'?'Send Empty To':dropDownValue == 'Diverted'?'Diverted From':'Crossing From',style: const TextStyle(fontWeight: FontWeight.bold),),
                                                    SizedBox(
                                                      // height: 35,
                                                      child: TextFormField(
                                              ...
                                              Expanded(
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    Text(dropDownValue == 'Send Empty'?'Send Empty To':dropDownValue == 'Diverted'?'Diverted To':'Crossing To',style: const TextStyle(fontWeight: FontWeight.bold),),
                                                    SizedBox(
                                                      // height: 35,
                                                      child: TextFormField(
                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    DateFieldWidget2(
                                                        dayController: dayControllerVehicleActivity,
                                                        monthController: monthControllerVehicleActivity,
                                                        yearController: yearControllerVehicleActivity,
                      ...
                      Wrap(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(border: Border.all(color: Colors.white, width: 1.5), borderRadius: BorderRadius.circular(5)),
                            child: Text(
                              widget.vehicleDetails['vehicle_number'].toString(),
                          ...
                          // Major Issue Button
                          ElevatedButton(
                              style: ElevatedButton.styleFrom(backgroundColor: ThemeColors.darkRedColor,
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                DateFieldWidget2(
                                                    dayController: dayControllerMajorIssue,
                                                    monthController: monthControllerMajorIssue,
                                                    yearController: yearControllerMajorIssue,
                              ...
                              }, child: const Text("Major Issues" , style: TextStyle(fontSize: 15),)),
                          const SizedBox(width: 20,),
                          // Documents Button
                          Stack(
                            children: [
                                        ...
                                        content:SizedBox(
                                          ...
                                          child: Padding(
                                            ...
                                            child: GridView.builder(
                                              ...
                                              shrinkWrap: true,
                                              itemCount: widget.vehicleDocument!.length,
                                              itemBuilder: (context, index) {
                                                String documentName = widget.vehicleDocument![index]['document_name'].toString();
                                                String documentPath = widget.vehicleDocument![index]['document_path'].toString();
                                                ...
                                                Widget iconWidget;
                                                if (fileExtension == 'png' || fileExtension == 'jpg' || fileExtension == 'jpeg' || fileExtension == 'img'||fileExtension == 'png...') {
                                                  iconWidget = Image.asset('assets/downloadimg.png', height: 80);
                                                } else {
                                                  iconWidget = Image.asset('assets/pdf-icon-4.png', height: 80);
                                                }
                                                ...
                                                return Card(
                                                  ...
                                                  child: InkWell(
                                                    onTap: () {
                                                      var url = '${GlobalVariable.trafficBaseURL}public/vehicle_Documents/$documentPath';
                                                      var docName = '$documentName${widget.vehicleDetails['vehicle_number']}.$fileExtension';
                                                      downloadFileOrPhoto(url, docName);
                                                    },
                                                    child: Padding(
                                                      padding: const EdgeInsets.all(8.0),
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            documentName,
                                                            style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold, overflow: TextOverflow.ellipsis),
                                                          ),
                              ...
                              Align(
                                ...
                                FadeTransition(
                                  ...
                                  child: Container(
                                    padding: const EdgeInsets.only(top: 6 , left: 7 , bottom: 7 , right: 6),
                                    decoration:  const BoxDecoration(
                                        shape: BoxShape.circle,
                                        color: ThemeColors.darkRedColor
                                    ),
                                    child: const Text("3" , style: TextStyle(color: Colors.white , fontWeight: FontWeight.w500 , fontSize: 11), ),
                                  ),
                                ),
                              ),
                            ],
        ...
        desktop: Container(
          ...
          decoration: BoxDecoration(
            // color: ThemeColors.primaryColor.withOpacity(1),
              gradient: LinearGradient(colors: [vehicleDetailsBGColor!, Colors.white]),
              borderRadius: BorderRadius.circular(8)),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            crossAxisAlignment: CrossAxisAlignment.center,
                                            ...
                                            children: [
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  placePrediction.isEmpty?const SizedBox():Expanded(
                                                    child: SizedBox(
                                                      width: 300,
                          ...
                          Stack(
                            children: [
                              ...
                              ElevatedButton(
                                  ...
                                  child: const Text("View Documents" , style: TextStyle(fontSize: 15),)),
                              Align(
                                alignment: const Alignment(012.0, -2),
                                heightFactor: 2,
                                widthFactor: 1.8,
                                child: FadeTransition(
                                  ...
                                  child: Container(
                                    ...
                                    child: const Text("3" , style: TextStyle(color: Colors.white , fontWeight: FontWeight.w500 , fontSize: 12), ),
                                  ),
                                ),
                              ),
                            ],
  ...
  void _showDateRangePicker() async {
    ...
    final dateRange = await showDateRangePicker(
      ...
      initialDateRange: _dateRange ?? DateTimeRange(start: initialDate, end: initialDate),
    ...
    if (dateRange != null) {
      setState(() {
        ...
        formattedStartDateApi = DateFormat('yyyy-MM-dd').format(dateRange.start);
  ...
  Future majorIssue() async {
    ...
    var url =Uri.parse('${GlobalVariable.trafficBaseURL}apis/MejorIssueVehicle');
    var body ={
  ...
  Future vehicleStatus() async {
    ...
    var url =Uri.parse('${GlobalVariable.trafficBaseURL}Traffic/VehicleStatus');
    var body ={
  ...
  Future<void> downloadFileOrPhotoWindows(String url, String fileName, BuildContext context) async {
    Dio dio = Dio();
