...
class RateHistory extends StatefulWidget {
  const RateHistory({Key? key}) : super(key: key);

  @override
  State<RateHistory> createState() => _RateHistoryState();
}

List<String> assignList = ['Select Ledger', 'Not Assign', 'Assign'];
List<String> entriesList = ["10", "20", "30", "40"];

class _RateHistoryState extends State<RateHistory> with Utility {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: UiDecoration.appBar("Rate History"),
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: TextDecorationClass().heading('Freight Rate History'),
            ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child:
                    SearchDropdownWidget(dropdownList: assignList, hintText: "Please Select Ledger", onChanged: (value) {
                      // This is called when the user selects an item.
                      setState(() {
