...
List totalList = [];
int totalAmount = 0;
class _PaymentState extends State<Payment> with Utility {
  ...
  TextEditingController dateControllerUI = TextEditingController(text: '${GlobalVariable.displayDate.day.toString().padLeft(2,'0')}-${GlobalVariable.displayDate.month.toString().padLeft(2,'0')}-${GlobalVariable.displayDate.year}');
  TextEditingController dateControllerApi = TextEditingController(text: '${GlobalVariable.displayDate.year}-${GlobalVariable.displayDate.month.toString().padLeft(2,'0')}-${GlobalVariable.displayDate.day.toString().padLeft(2,'0')}');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: UiDecoration.appBar('Payment'),
                                        ...
                                        onChanged: (value) {
                                          ...
                                          for(int i=0; i<ledgerTitleList.length; i++){
                                            if(ledgerList[i]['ledger_title'] == value){
                                              employeeID = ledgerList[i]['ledger_id'];
                                            }
                                          }
                                        },
                                        selectedItem: value2,
  ...
  Future transactionApi() async {
    ...
    var url = Uri.parse("${GlobalVariable.baseURL}Account/PaymentTransaction");

    var body = {
      'ledger_id':oppLedgerID.toString(), // sending multiple {"ledger_id" and "amount" and "vehicle_id"} in "idAndAmountList"
      'opp_ledger_id':jsonEncode(idAndAmountList),
