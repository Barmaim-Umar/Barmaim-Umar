...
List totalList = [];
int totalAmount = 0;
class _JournalState extends State<Journal> with Utility {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: UiDecoration.appBar('Journal'),
  ...
  Future journalApi() async {
    ...
    var url = Uri.parse("${GlobalVariable.baseURL}Account/JournalTransaction");

    var body = {
      'opp_ledger_id': jsonEncode(idAndAmountList).toString(), // sending multiple {"ledger_id" and "amount"} in idAndAmountList
