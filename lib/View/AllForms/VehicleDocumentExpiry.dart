...
class VehicleDocumentExpiry extends StatefulWidget {
  const VehicleDocumentExpiry({Key? key}) : super(key: key);

  @override
  State<VehicleDocumentExpiry> createState() => _VehicleDocumentExpiryState();
}

List<String> assignDropdownList = ['All Vehicle' , 'Not Assign' , 'Assign'];
List<String> entriesDropdownList = ["10" ,"20" ,"30" ,"40"];

class _VehicleDocumentExpiryState extends State<VehicleDocumentExpiry> with Utility{
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: TextDecorationClass().heading('Vehicle Document Expiry Report'),
            ),
            const Divider(),
            // dropdown & search
            Padding(
...
class MyData extends DataTableSource {
  final List<Map<String, dynamic>> _data = List.generate(
      ...
      (index) => {
            ...
            "id4": index,
            "title5": "Item $index",
            "price6": Random().nextInt(10000),
            "price7": Random().nextInt(10000),
          });
