...
class FreightRateList extends StatefulWidget {
  const FreightRateList({Key? key}) : super(key: key);

  @override
  State<FreightRateList> createState() => _FreightRateListState();
}

List<String> assignDropdownList = ['Select Ledger', 'Not Assign', 'Assign'];
List<String> entriesDropdownList = ["10", "20", "30", "40"];

class _FreightRateListState extends State<FreightRateList> with Utility {
      ...
      cells: [
        ...
        DataCell(Row(
          children: [
            ...
            ElevatedButton(
              style: ButtonStyles.customiseButton(Colors.green, Colors.white, 30.0, 38.0),
              onPressed: () {},
              child: const Text('Add'),
            ),
            const SizedBox(width: 5),
            ElevatedButton(
              style: ButtonStyles.customiseButton(Colors.orange, Colors.white, 30.0, 38.0),
              onPressed: () {},
              child: const Text('History'),
            ),
            const SizedBox(width: 5),
            ElevatedButton(
              style: ButtonStyles.customiseButton(Colors.red, Colors.white, 30.0, 38.0),
              onPressed: () {},
